...
from fairseq.models import FairseqBertEncoderDecoderModel
...
class TransformerBertModelBase(FairseqBertEncoderDecoderModel):
    """
    ...
    def __init__(self, cfg, encoder, decoder, bertencoder, berttokenizer, mask_cls_sep=False, args=None):
        super().__init__(encoder, decoder, bertencoder, berttokenizer, mask_cls_sep=False, args=None)
        self.cfg = cfg
    ...
    def build_model(cls, cfg, task):
        ...
        if len(task.datasets) > 0:
            ...
            src_berttokenizer = BertTokenizer.from_pretrained(cfg.bert_model_name)
    ...
    def build_encoder(cls, cfg, src_dict, embed_tokens):
        return TransformerBertEncoder(cfg, src_dict, embed_tokens)

    @classmethod
    def build_decoder(cls, cfg, tgt_dict, embed_tokens):
        return TransformerBertDecoder(
            cfg,
            tgt_dict,
            embed_tokens,
    ...
    def forward(
        ...
        encoder_out = self.encoder(
            src_tokens, src_lengths=src_lengths, bert_encoder_out=bert_encoder_out, return_all_hiddens=return_all_hiddens
        )
